        ...
        <section className="max-w-5xl mx-auto px-4 py-12" id="submission">
            ...
            <div className="flex flex-wrap gap-3 mb-8 justify-center sm:justify-start">
                <button
                    ...
                    className={`flex items-center justify-center px-3 py-2 sm:px-6 sm:py-4 text-sm border rounded-md transition ${activeTab === "conference"
                ...
                <button
                    ...
                    className={`flex items-center justify-center px-3 py-2 sm:px-6 sm:py-4 text-sm border rounded-md transition ${activeTab === "journal"
                            ? "bg-yellow-400 text-white"
                            : "bg-white text-gray-800 border-gray-300"
                        }`}
                >
